...
# 台灣主要作物基肥施用庫（碩成有機質肥料業務決策用）
# 欄位：類別、名稱、emoji、基肥適用月份、主要地區、每甲用量 kg、使用機率(高中低)、備註
# 使用機率高=年 2-3 次基肥、中=年 1-2 次、低=1-2 年 1 次
CROPS_DB = [
    # ===== 果樹（熱帶）=====
    ("果樹", "芒果", "🥭", [11,12,1,2], ["南部","中部"], 1500, "高", "採收前30天禁施"),
    ("果樹", "荔枝", "🍒", [10,11,12], ["中部","南部"], 1500, "高", "6月採收前禁施"),
    ("果樹", "龍眼", "🍯", [11,12,1], ["南部","中部"], 1200, "中", ""),
    ("果樹", "香蕉", "🍌", [3,4,5,9,10], ["南部","中部"], 2500, "高", "年多次基肥"),
    ("果樹", "鳳梨", "🍍", [2,3,10,11], ["南部","中部"], 1800, "高", ""),
    ("果樹", "木瓜", "🥭", [3,4,9,10], ["南部"], 2000, "中", ""),
    ("果樹", "蓮霧", "🌸", [5,6,7], ["南部"], 1500, "中", ""),
    ("果樹", "番石榴", "🥝", [3,4,10,11], ["中部","南部"], 2000, "高", "四季採收"),
    ("果樹", "酪梨", "🥑", [11,12,1], ["中部","南部"], 1200, "中", ""),
    ("果樹", "火龍果", "🐉", [3,4,10,11], ["南部","中部"], 1800, "高", "夜間補光需高肥"),
    ("果樹", "釋迦", "🍏", [3,4,9,10], ["東部"], 2000, "中", "台東主力"),
    # ===== 果樹（柑橘/溫帶）=====
    ("果樹", "椪柑", "🍊", [11,12,1], ["中部"], 1500, "高", "採收前30天禁施"),
    ("果樹", "桶柑", "🍊", [11,12,1], ["中部","北部"], 1500, "中", ""),
    ("果樹", "麻豆文旦", "🍋", [11,12,1], ["南部"], 1500, "高", "麻豆為主"),
    ("果樹", "水梨", "🍐", [10,11,12], ["中部"], 1500, "中", "高山"),
    ("果樹", "葡萄", "🍇", [3,4,9,10], ["中部"], 1500, "中", "彰化"),
    ("果樹", "蜜棗", "🌰", [6,7,8], ["南部"], 1500, "中", ""),
    ("果樹", "百香果", "💜", [3,4,9,10], ["南部","東部"], 1500, "中", ""),
    # ===== 葉菜 =====
    ...
    # ===== 瓜果類 =====
    ("瓜果類", "西瓜", "🍉", [2,3,4], ["南部","中部"], 2000, "高", ""),
    ("瓜果類", "洋香瓜", "🍈", [2,3,9,10], ["南部"], 1800, "中", ""),
    ("瓜果類", "番茄", "🍅", [9,10,11], ["南部","中部"], 1500, "高", ""),
    ("瓜果類", "辣椒/彩椒", "🌶️", [2,3,9,10], ["南部"], 1200, "中", ""),
    ("瓜果類", "茄子", "🍆", [3,4,9,10], ["南部"], 1500, "中", ""),
    ("瓜果類", "絲瓜/苦瓜", "🥒", [3,4,5,9,10], ["南部"], 1500, "中", ""),
